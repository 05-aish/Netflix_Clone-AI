...
A full-stack Netflix-inspired movie browsing application built with the MERN stack. Features real-time movie data from TMDB, AI-powered recommendations via Google Gemini, JWT-based authentication, and per-user watch history.
...
- AI-powered movie recommendations via Google Gemini, driven by a user preference questionnaire
...
```bash
git clone https://github.com/05-aish/Netflix_Clone-AI.git
cd netflixclone
```
...
[GitHub](https://github.com/05-aish) · [LinkedIn](www.linkedin.com/in/aishwarya-mandal-6b79b6279)
