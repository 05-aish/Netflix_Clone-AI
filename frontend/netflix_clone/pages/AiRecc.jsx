...
const steps = [
    ...
    },
    {
        ...
        options: ["2026", "2010s", "2000s", "1990s", "Older"]
    },
    {
        name: "language",
    ...
    <div className='relative w-full max-w-md mx-auto rounded-2xl bg-[#181818]/90 shadow-2xl border border-[#333] px-8 py-10 mt-4 flex flex-col items-center min-h-[480px]'>
        ...
        <div className='w-full flex flex-col'>
            ...
            <div className='flex justify-between items-center mt-6'>
                <button className='px-6 py-2 rounded-lg font-semibold transition border-2 border-[#444] text-white bg-[#181818] hover:bg-[#232323]'>Back</button>
                <button 
                onClick={handleNext}
